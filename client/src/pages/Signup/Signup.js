        ...
        <div className='auth-signup__wrapper'>
            <div className="navbar">
                <NavLink to="/" activeClassName="active-link">
                    <div className="navbar__logo">Influencia</div>
                </NavLink>
            </div>
            <div className='foorm_'>
                <div className='foorm2_'>
            <div className="signup__wrapper">
                ...
                <form onSubmit={formik.handleSubmit}>
                    <label class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        <input className='inputPannel' type="text" id="fullname" name='fullname' placeholder='Full Name' onChange={formik.handleChange} value={formik.values.fullname} />
                    </label>
                    <label class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        <input className='inputPannel' type="text" id="username" name='username' placeholder='Username' onChange={formik.handleChange} value={formik.values.username} />
                    </label>
                    <label class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        <input className='inputPannel' type="email" id="email" name="email" placeholder='Email' onChange={formik.handleChange} value={formik.values.email} />
                        <p className="info__validation email__validation">{formik.errors.email}</p>
                    </label>
                    <label class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        <input className='inputPannel' type="password" id="password" name="password" placeholder='Password' onChange={formik.handleChange} value={formik.values.password} />
                        <p className="info__validation password__validation">{formik.errors.password}</p>
                    </label>
                    <label class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        <input className='inputPannel' type="password" id="confirmPassword" name="confirmPassword" placeholder='Confirm password' onChange={formik.handleChange} value={formik.values.confirmPassword} />
