...
function GetOrderActions({ status, updateOrderStatus, orderId }) {
    ...
    const amount = data.orderById.price;
    const currency = "INR";
    const receiptId = data.orderById.id;


    // const paymentHandler = async (e) => {
    //     const response = await fetch("http://localhost:4000/orderpaymentrazor", {
    //       method: "POST",
    //       body: JSON.stringify({
    //         amount,
    //         currency,
    ...
    //     var options = {
    //       key: "rzp_test_Dk9gjJoMsW5vDH", // Enter the Key ID generated from the Dashboard
    ...
    //         name: "influencia", //your customer's name
    //         email: "influencia@example.com",
